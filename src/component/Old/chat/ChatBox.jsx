...
export default function ChatBox() {
  const [chats, setChats] = useState([
    ...
    },
    {
      ...
      message: "Sorry Guys, I was little busy before but now all set. Lets plan something... I am too tired with this week",
      isSent: true,
    ...
    {
      sender: { name: "Danishan", dp: "./person1" },
      message: "How about... swiming ? I want to something like child, its too hot",
      isSent: true,
    ...
    {
      sender: { name: "Danishan", dp: "./person1" },
      message: "Okay now we are on one-one lets take salman vote as well and than will decide...",
      isSent: true,
    ...
    {
      sender: { name: "Salman", dp: "../../img/defaultDp.jpg" },
      message: "Oh yeah, Suddenly I feel like very Important... But I think sahil is right, we should go for Ice Skating..",
      isSent: false,
